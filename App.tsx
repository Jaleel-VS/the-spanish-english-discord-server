        ...
        <section className="space-y-8 max-w-2xl">
          ...
          <div className="pt-6 flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-slate-400">
              <a href="/coming-soon.html" className="hover:text-[#fb923c] transition-colors duration-200">{t('common:links.newToDiscord')}</a>
              <span className="text-slate-700">•</span>
              <a href="/coming-soon.html" className="hover:text-[#fb923c] transition-colors duration-200">{t('common:links.guidelines')}</a>
              <span className="text-slate-700">•</span>
              <a href="/coming-soon.html" className="hover:text-[#fb923c] transition-colors duration-200">{t('common:links.resources')}</a>
              <span className="text-slate-700">•</span>
              <a href="/coming-soon.html" className="hover:text-[#fb923c] transition-colors duration-200">{t('common:links.support')}</a>
            </div>
          </div>
        </section>
      </main>
